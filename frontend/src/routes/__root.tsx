  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/7f707209-4c9a-4ea7-a021-794ac3f5278b/id-preview-2b715aa8--ea78dcdb-df85-4902-86c2-feeca4b9ba0b.lovable.app-1777809159074.png",
      },
      {
        name: "twitter:image",
        content:
